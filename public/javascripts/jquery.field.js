			...
			function (){
				...
				var checkboxClicked = function (e){
					...
					for( var i=low; i < high; i++ ){
                        ...
                        var previousValue = self.eq(i).val("checked");

                        if(previousValue=="checked"){
                            self.eq(i).prop("checked", false);
                            self.eq(i).removeAttr("checked");
                        }else{
                            self.eq(i).prop("checked", true);
                            self.eq(i).attr("checked", "checked");
                        }
